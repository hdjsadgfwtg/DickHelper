import type { IRecord, IRecordRaw, IStats, IDailyCount, IImportResult, ICommunityStats, IAppConfig, IHourlyCount, IWeekdayCount, IMonthlyCount } from "@dickhelper/shared";
